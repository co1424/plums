  ...
  return (
    <div className="border-2 rounded-lg max-w-xs min-w-80 p-3 max-h-[500px] overflow-hidden relative group">
      ...
      <div className='bg-white h-16 w-full absolute bottom-0 right-0 justify-end items-center  flex'>
        <button className='hover:bg-black hover:bg-opacity-10 rounded-md active:bg-white p-1 mx-2 opacity-0 group-hover:opacity-100 group-hover:transition-opacity group-hover:duration-500'>
        <TbTrash size={"2em"}/>
        </button>
      </div>
    </div>
